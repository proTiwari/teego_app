...
class Constants {
  ...
  static String s3RegionConfig = "eu-north-1";
  static String s3BucketConfig = "bucket-shortzz";
  static String s3UrlConfig = "https://bucket-shortzz.s3.eu-north-1.amazonaws.com/";
  static String s3AccessKeyConfig = "AKIARD4YVPNP4LJ3ZAGH";
  static String s3SecretKeyConfig = "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";
